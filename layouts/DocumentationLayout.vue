...
const listprop = ref([
  ...
  { title: "Development Roadmap", _path: "/docs/en/roadmap" },
  {
    title: "API",
    _path: "/docs/en/api",
    children: [{ title: "API Usage", _path: "/docs/en/api/usage" }],
    icon: "💻",
  },
  {
    title: "Self-Hosted",
    _path: "/docs/en/selfhosted",
    children: [
      {
        title: "Install via Docker",
        _path: "/docs/en/selfhosted/install-via-docker",
      },
    ],
    icon: "☁️",
  },
...
<template>
  <div class="drawer laptop:drawer-open">
    ...
    <div class="drawer-content flex flex-col">
      <!-- Navbar -->
      <div
        class="w-full navbar bg-base-100/70 sticky top-0 shadow-sm backdrop-blur-lg z-10"
      >
        <div class="flex-1 max-tablet:hidden">
          <input
            class="input input-ghost w-1/2"
            :placeholder="$t('docs.nav.search_docs_placeholder')"
          />
        </div>
        <div class="flex-none laptop:hidden flex flex-row">
          <div class="flex flex-row">
            <label
              for="docs-layout-drawer"
            ...
            <a class="btn btn-ghost" href="/">
              <div class="object-contain size-8 rounded-3xl flex items-center">
                <img
                  src="~/assets/moodhelper_icon.png"
                  alt="MoodHelper Icon"
                  class="rounded-3xl object-contain w-full h-full"
                />
              </div>
    ...
    <div class="drawer-side laptop:p-3 laptop:flex laptop:flex-col">
      ...
      <MenuTreeLister
        class="menu p-4 bg-base-100 w-full max-tablet:w-1/3 max-h-screen max-tablet:min-h-full"
        :list="listprop"
      />
    </div>
  </div>
